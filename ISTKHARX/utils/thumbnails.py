...
async def get_thumb(videoid):
    ...
    try:
        ...
        bg = Image.open(f"ISTKHARX/assets/THUNDER.png")
        ...
        font = ImageFont.truetype("ISTKHARX/assets/font2.ttf", 45)
        font2 = ImageFont.truetype("ISTKHARX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("ISTKHARX/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("ISTKHARX/assets/font.ttf", 30)
