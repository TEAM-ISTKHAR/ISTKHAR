...
from ISTKHARX.utils import MUSARRATBin, get_channeplayCB, seconds_to_min
from ISTKHARX.utils.database import get_cmode, is_active_chat, is_music_playing
from ISTKHARX.utils.decorators.language import language, languageCB
from ISTKHARX.utils.inline import queue_back_markup, queue_markup
             ...
             [
                 [
                      InlineKeyboardButton(
                         "• 𝖧ᴀᴄᴋᴇᴅ вʏ  •", url=f"https://t.me/ll_THUNDER_lll")
                 ]
            ]
         ),
   )
