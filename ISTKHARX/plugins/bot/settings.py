...
from ISTKHARX.utils.decorators.admins import ActualAdminCB
from ISTKHARX.utils.decorators.language import language, languageCB
from ISTKHARX.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ISTKHARX.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("THUNDER_ISTKHARX") & ~BANNED_USERS)
@languageCB
